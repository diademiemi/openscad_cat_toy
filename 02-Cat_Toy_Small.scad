...
solid_4 = openface(solid_3,outer_inset_ratio=0.23,inner_inset_ratio=0.15,depth=1.3,fn=[]);
scale(3) show_solid(solid_4);
...
translate([0,0,6.5]) rotate([(1/2 * acos(-(sqrt(5) / 3 )) - 90),0,0]) union() {
  icosahedron(8.5);
}
