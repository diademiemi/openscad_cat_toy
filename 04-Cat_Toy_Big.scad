...
solid_4 = openface(solid_3,outer_inset_ratio=0.25,inner_inset_ratio=0.12,depth=1.1,fn=[]);
scale(6) show_solid(solid_4);
...
translate([0,0,15.1]) rotate([(1/2 * acos(-(sqrt(5) / 3 )) - 90),0,0]) union() {
  icosahedron(20);
}
